    ...
    >
      <div className="flex items-center justify-center min-h-screen">
        ...
        <div className="relative bg-white rounded-md max-w-sm mx-auto w-96 p-4">
          <Dialog.Title className="mb-4 text-xl font-semibold flex flex-row items-start">
            <h3 className="my-2">New Question</h3>
            <button type="button" className="ml-auto px-2" onClick={onClose}>
              ⨉
            </button>
          </Dialog.Title>
